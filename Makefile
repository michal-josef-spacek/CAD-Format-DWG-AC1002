# This Makefile is for the CAD::Format::DWG::AC1002 extension to perl.
#
...
#     ABSTRACT => q[Read AutoCAD r2.5 DWG file.]
#     AUTHOR => [q[Michal Josef Spacek <skim@cpan.org>]]
#     BUILD_REQUIRES => { English=>q[0], Error::Pure::Utils=>q[0.22], ExtUtils::MakeMaker=>q[6.59], File::Object=>q[0.05], Test::More=>q[0], Test::NoWarnings=>q[0] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[CAD-Format-DWG-AC1002]
#     LICENSE => q[bsd]
#     MIN_PERL_VERSION => q[5.008]
#     NAME => q[CAD::Format::DWG::AC1002]
#     NO_META => q[1]
#     PREREQ_PM => { Encode=>q[0], English=>q[0], Error::Pure::Utils=>q[0.22], ExtUtils::MakeMaker=>q[6.59], File::Object=>q[0.05], IO::KaitaiStruct=>q[0], Test::More=>q[0], Test::NoWarnings=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
#     dist => {  }
...
NAME_SYM = CAD_Format_DWG_AC1002
VERSION = 0.01
...
MAKE = make
FULLEXT = CAD/Format/DWG/AC1002
BASEEXT = AC1002
PARENT_NAME = CAD::Format::DWG
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
INST_LIBDIR      = $(INST_LIB)/CAD/Format/DWG
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/CAD/Format/DWG
...
DISTNAME = CAD-Format-DWG-AC1002
DISTVNAME = CAD-Format-DWG-AC1002-0.01
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  AC1002.pod $(INST_MAN3DIR)/CAD::Format::DWG::AC1002.$(MAN3EXT) 
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="CAD-Format-DWG-AC1002" VERSION="0.01">' > CAD-Format-DWG-AC1002.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Read AutoCAD r2.5 DWG file.</ABSTRACT>' >> CAD-Format-DWG-AC1002.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Michal Josef Spacek &lt;skim@cpan.org&gt;</AUTHOR>' >> CAD-Format-DWG-AC1002.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> CAD-Format-DWG-AC1002.ppd
	$(NOECHO) $(ECHO) '        <PERLCORE VERSION="5,008,0,0" />' >> CAD-Format-DWG-AC1002.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Encode::" />' >> CAD-Format-DWG-AC1002.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="IO::KaitaiStruct" />' >> CAD-Format-DWG-AC1002.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.28" />' >> CAD-Format-DWG-AC1002.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> CAD-Format-DWG-AC1002.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> CAD-Format-DWG-AC1002.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> CAD-Format-DWG-AC1002.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'AC1002.pm' '$(INST_LIB)/CAD/Format/DWG/AC1002.pm' \
	  'AC1002.pod' '$(INST_LIB)/CAD/Format/DWG/AC1002.pod' 
